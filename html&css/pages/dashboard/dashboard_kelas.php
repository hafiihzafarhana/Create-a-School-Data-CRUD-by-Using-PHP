...
$result = ambil_data("Select * FROM tb_ruang_kelas");
...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>Dashboard Ruang Kelas</title>
...
<body>
  ...
  <main class="content">
    ...
    <div class="py-4">
        <a href="./tambah_data_kelas.php" class="btn btn-success text-white">
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0">Tipe Kelas</th>
                                    <th class="border-0">Kapasitas Kelas</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td><?php echo $i; ?></td>
                                  <td><?php echo $data["IDRuang"]; ?></td>
                                  <td><?php echo $data["Nama_Ruang"]; ?></td>
                                  <td><?php echo $data["Tipe_Ruang"]; ?></td>
                                  <td><?php echo $data["Kapasitas_Ruang"]; ?></td>
                                  <td>
                                    <a href="edit_data_kelas.php?id=<?php echo $data["IDRuang"]?>" class="btn btn-warning badge">Edit</a>
                                    <a href="detail_data_kelas.php?id=<?php echo $data["IDRuang"]?>" class="btn btn-info badge">Detail</a>
                                    <a href="hapus_data_kelas.php?id=<?php echo $data['IDRuang']?>" class="btn btn-danger badge">Hapus</a>
                                  </td>
                                </tr>
                                <!-- End of Item -->
                                <?php $i++ ?>
