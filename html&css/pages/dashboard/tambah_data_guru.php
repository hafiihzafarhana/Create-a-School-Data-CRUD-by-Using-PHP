...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Guru | Tambah Data</title>
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="NamaGuru" id="NamaGuru" placeholder="Masukan Nama Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="GelarDepan" id="GelarDepan" placeholder="Masukan Gelar Depan Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="GelarBelakang" id="GelarBelakang" placeholder="Masukan Gelar Belakang Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="my-4">
                            ...
                            <textarea class="form-control" placeholder="Masukan Alamat Guru" name="AlamatGuru" id="AlamatGuru" rows="4"></textarea>
                        </div>
                        <!-- End of Form -->
                    ...
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="Kota_Lahir" id="Kota_Lahir" placeholder="Masukan Tempat Lahir Guru">
                        </div>
                        <!-- End of Form -->

                        <div class="mb-4">
                            <label for="TglLahirGuru">Tanggal Lahir Guru</label>
                            <input type="date" class="form-control" name="TglLahirGuru" id="TglLahirGuru" placeholder="Masukan Tanggal Lahir Guru">
                        </div>

                        <div class="mb-4">
                            <label for="NoHPGuru">No HP Guru</label>
                            <input type="text" class="form-control" name="NoHPGuru" id="NoHPGuru" placeholder="Masukan No HP Guru">
                        </div>

                        <div class="mb-4">
                            <label for="NoWAGuru">No WA Guru</label>
                            <input type="text" class="form-control" name="NoWAGuru" id="NoWAGuru" placeholder="Masukan No WA Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDTelegramGuru">ID Telegram Guru</label>
                            <input type="text" class="form-control" name="IDTelegramGuru" id="IDTelegramGuru" placeholder="Masukan ID Telegram Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDLineGuru">ID Line Guru</label>
                            <input type="text" class="form-control" name="IDLineGuru" id="IDLineGuru" placeholder="Masukan ID Line Guru">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-4">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="IDFacebookGuru" id="IDFacebookGuru" placeholder="Masukan ID Facebook Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDInstagramGuru">ID Instagram Guru</label>
                            <input type="text" class="form-control" name="IDInstagramGuru" id="IDInstagramGuru" placeholder="Masukan ID Instagram Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDTwitterGuru">ID Twitter Guru</label>
                            <input type="text" class="form-control" name="IDTwitterGuru" id="IDTwitterGuru" placeholder="Masukan ID Twitter Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDYoutubeGuru">ID Youtube Guru</label>
                            <input type="text" class="form-control" name="IDYoutubeGuru" id="IDYoutubeGuru" placeholder="Masukan ID Youtube Guru">
                        </div>

                        <div class="mb-4">
                            <label for="EmailGuru">Email Guru</label>
                            <input type="email" class="form-control" name="EmailGuru" id="EmailGuru" placeholder="Masukan Email Guru">
                        </div>
