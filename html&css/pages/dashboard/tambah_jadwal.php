...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Jadwal | Tambah Data</title>
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="IDJadwal" id="IDJadwal" placeholder="Masukan ID Jadwal">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="No_Induk" name="No_Induk">
                                <?php 
                                    ...
                                    <option value="<?php echo $data['No_Induk'];?>"><?php echo $data['Nama_Murid']; ?> &nbsp;[<?php echo $data["No_Induk"] ?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="Kode_MaPel" name="Kode_MaPel">
                                <?php 
                                    ...
                                    <option value="<?php echo $data['Kode_MaPel'];?>"><?php echo $data['Nama_Mapel'];?>&nbsp;[<?php echo $data['Kode_MaPel'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="IDGuru" name="IDGuru">
                                <?php 
                                    ...
                                    <option value="<?php echo $data['IDGuru'];?>"><?php echo $data['NamaGuru'];?>&nbsp;[<?php echo $data['IDGuru'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="IDRuang" name="IDRuang">
                                <?php 
                                    ...
                                    <option value="<?php echo $data['IDRuang'];?>"><?php echo $data['Nama_Ruang'];?>&nbsp;[<?php echo $data['IDRuang'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" placeholder="Masukan Sesi Jadwal" name="SesiJadwal" id="SesiJadwal">
                        </div>

                        <div class="mb-4">
                            <label for="Waktu_Mulai">Waktu Mulai</label>
                            <input class="form-control" type="time" placeholder="Masukan Waktu Mulai" name="Waktu_Mulai" id="Waktu_Mulai">
                        </div>
