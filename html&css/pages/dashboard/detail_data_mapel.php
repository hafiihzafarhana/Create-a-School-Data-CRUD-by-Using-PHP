...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Mapel | Detail Data | <?php echo $detailMapel["Nama_Mapel"] ?></title>
...
<body>
    ...
    <main class="content">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center">Detail Data Mapel</h3>
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" disabled value="<?php echo $detailMapel["Nama_Mapel"] ?>" class="form-control" name="Nama_Mapel" id="Nama_Mapel" placeholder="Masukan Nama Mapel">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" disabled value="<?php echo $detailMapel["Bidang_Mapel"] ?>" class="form-control" name="Bidang_Mapel" id="Bidang_Mapel" placeholder="Masukan Bidang Mapel">
                        </div>

                        <div class="mb-4">
                            <label for="Jenis_Mapel">Jenis Mapel</label>
                            <input type="text" disabled value="<?php echo $detailMapel["Jenis_Mapel"] ?>" class="form-control" name="Jenis_Mapel" id="Jenis_Mapel" placeholder="Masukan Jenis Mapel">
                        </div>

                        <div class="mb-4">
                            <label for="Tipe_Mapel">Tipe Mapel</label>
                            <input type="text" disabled value="<?php echo $detailMapel["Tipe_Mapel"] ?>" class="form-control" name="Tipe_Mapel" id="Tipe_Mapel" placeholder="Masukan Tipe Mapel">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" disabled value="<?php echo $detailMapel["Jumlah_Pertemuan"] ?>" class="form-control" name="Jumlah_Pertemuan" id="Jumlah_Pertemuan" placeholder="Masukan Jumlah Pertemuan">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" disabled value="<?php echo $detailMapel["Durasi_Mapel"] ?>" class="form-control" name="Durasi_Mapel" id="Durasi_Mapel" placeholder="Masukan Durasi Mapel">
                        </div>
