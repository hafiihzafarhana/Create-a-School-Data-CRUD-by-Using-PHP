...
if (isset($_POST['tambah'])) {
    if (tambah_data_mapel($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'tambah_data_mapel.php';
        </script>
        ";
    }
}
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Mapel | Tambah Data</title>
...
<body>
    ...
    <main class="content">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center">Tambah Data Mapel</h3>
                </div>
            </div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="Kode_MaPel" id="Kode_MaPel" placeholder="Masukan Kode Mapel">
                        </div>
                        <!-- End of Form -->
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" maxlength="2" type="text" placeholder="Masukan Jumlah Pertemuan" name="Jumlah_Pertemuan" id="Jumlah_Pertemuan">
                        </div>

                        <div class="mb-4">
                            <label for="Durasi_Mapel">Durasi Mapel</label>
                            <input class="form-control"  type="time" placeholder="Masukan Durasi Waktu" name="Durasi_Mapel" id="Durasi_Mapel">
                        </div>
