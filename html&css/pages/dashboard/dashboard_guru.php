...
$result = ambil_data("Select * FROM tb_guru");
...
<body>
  ...
  <main class="content">
    ...
    <div class="py-4">
        <a href="./tambah_data_guru.php" class="btn btn-success text-white">
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $data["NoWAGuru"]; ?></td>
                                  <td>
                                    <a href="edit_data_guru.php?id=<?php echo $data["IDGuru"]?>" class="btn btn-warning badge">Edit</a>
                                    <a href="detail_data_guru.php?id=<?php echo $data["IDGuru"]?>" class="btn btn-info badge">Detail</a>
                                    <a href="hapus_data.php?id=<?php echo $data['IDGuru']?>" class="btn btn-danger badge">Hapus</a>
                                  </td>
                                </tr>
                                <!-- End of Item -->
                                <?php $i++ ?>
