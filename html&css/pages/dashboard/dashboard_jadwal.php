...
$kode = 'jadwal1';
$result = ambil_data("SELECT * FROM tb_jadwal_pelajaran");
...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>Dashboard Jadwal Pelajaran</title>
...
<body>
  ...
  <main class="content">
    ...
    <div class="py-4">
        <a href="./tambah_jadwal.php" class="btn btn-success text-white">
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <!-- <th class="border-0">Hari Jadwal</th> -->
                                    <th class="border-0">Sesi Jadwal</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td><?php echo $i; ?></td>
                                  <!-- <td><?php echo $data["HariJadwal"]; ?></td> -->
                                  <td><?php echo $data["SesiJadwal"]; ?></td>
                                  <td><?php echo $data["Waktu_Mulai"]; ?></td>
                                  <td><?php echo $data["Waktu_Selesai"]; ?></td>
                                  <td>
                                    <a href="edit_data_jadwal.php?id=<?php echo $data["IDJadwal"]?>" class="btn btn-warning badge">Edit</a>
                                    <a href="detail_data_jadwal.php?id=<?php echo $data["IDJadwal"]?>" class="btn btn-info badge">Detail</a>
                                    <a href="hapus_data_jadwal.php?id=<?php echo $data['IDJadwal']?>" class="btn btn-danger badge">Hapus</a>
                                  </td>
                                </tr>
                                <!-- End of Item -->
                                <?php $i++ ?>
