...
$result = ambil_data("Select * FROM tb_mata_pelajaran");
...
<head>
  ...
  <!-- <script src="https://kit.fontawesome.com/0e4bb3211b.js" crossorigin="anonymous"></script> -->
</head>
...
<body>
  ...
  <main class="content">
    ...
    <div class="py-4">
        <a href="./tambah_data_mapel.php" class="btn btn-success text-white">
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="border-0">Bidang Mapel</th>
                                    <th class="border-0">Jumlah Pertemuan</th>
                                    <th class="border-0">Durasi Mapel</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $data["Bidang_Mapel"]; ?></td>
                                  <td><?php echo $data["Jumlah_Pertemuan"]; ?></td>
                                  <td><?php echo $data["Durasi_Mapel"]; ?>&nbsp;Jam</td>
                                  <td>
                                    <a href="edit_data_mapel.php?id=<?php echo $data["Kode_MaPel"]?>" class="btn btn-warning badge">Edit</a>
                                    <a href="detail_data_mapel.php?id=<?php echo $data["Kode_MaPel"]?>" class="btn btn-info badge">Detail</a>
                                    <a href="hapus_data_mapel.php?id=<?php echo $data['Kode_MaPel']?>" class="btn btn-danger badge">Hapus</a>
                                  </td>
                                </tr>
                                <!-- End of Item -->
                                <?php $i++ ?>
