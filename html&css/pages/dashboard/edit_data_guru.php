...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Guru | Edit Data | <?php echo $dataDetailGuru["NamaGuru"] ?></title>
    ...
    <main class="content">
        ...
        <div class="card-body">
            ...
            <form action="" method="POST">
                <input type="hidden" name="IDGuru" id="IDGuru" value="<?php echo $dataDetailGuru['IDGuru'] ?>">
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["NamaGuru"]; ?>" name="NamaGuru" id="NamaGuru" placeholder="Masukan Nama Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["GelarDepan"]; ?>" name="GelarDepan" id="GelarDepan" placeholder="Masukan Gelar Depan Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["GelarBelakang"]; ?>" name="GelarBelakang" id="GelarBelakang" placeholder="Masukan Gelar Belakang Guru">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="JKGuru" name="JKGuru">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="AgamaGuru" name="AgamaGuru">
                                <?php if ($dataDetailGuru["AgamaGuru"] == "islam") : ?>
                                    <option>---Pilih---</option>
                                ...
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "protestan") : ?>
                                    <option>---Pilih---</option>
                                    ...
                                    <option value="konghucu">Konghucu</option>
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "katolik") : ?>
                                    <option>---Pilih---</option>
                                    <option value="islam">Islam</option>
                                    <option value="protestan">Protestan</option>
                                    ...
                                    <option value="konghucu">Konghucu</option>
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "hindu") : ?>
                                    <option>---Pilih---</option>
                                    <option value="islam">Islam</option>
                                    <option value="protestan">Protestan</option>
                                    <option value="katolik">Katolik</option>
                                    ...
                                    <option value="konghucu">Konghucu</option>
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "budha") : ?>
                                    <option>---Pilih---</option>
                                    <option value="islam">Islam</option>
                                    <option value="protestan">Protestan</option>
                                    <option value="katolik">Katolik</option>
                                    ...
                                    <option value="konghucu">Konghucu</option>
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "konghucu") : ?>
                                    <option>---Pilih---</option>
                                    <option value="islam">Islam</option>
                                    <option value="protestan">Protestan</option>
                                    <option value="katolik">Katolik</option>
                                ...
                                <?php endif; ?>
                                <?php if ($dataDetailGuru["AgamaGuru"] == "--Pilih--") : ?>
                                    <option selected>---Pilih---</option>
                                    <option value="islam">Islam</option>
                                    <option value="protestan">Protestan</option>
                                    <option value="katolik">Katolik</option>
                        ...
                        <div class="my-4">
                            ...
                            <textarea class="form-control" placeholder="Masukan Alamat Guru" name="AlamatGuru" id="AlamatGuru" rows="4"><?php echo $dataDetailGuru["AlamatGuru"]; ?></textarea>
                        </div>
                        <!-- End of Form -->
                    ...
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="Kota_Lahir" value="<?php echo $dataDetailGuru["Kota_Lahir"]; ?>" id="Kota_Lahir" placeholder="Masukan Tempat Lahir Guru">
                        </div>
                        <!-- End of Form -->

                        <div class="mb-4">
                            <label for="TglLahirGuru">Tanggal Lahir Guru</label>
                            <input type="date" class="form-control" value="<?php echo $dataDetailGuru["TglLahirGuru"]; ?>" name="TglLahirGuru" id="TglLahirGuru" placeholder="Masukan Tanggal Lahir Guru">
                        </div>

                        <div class="mb-4">
                            <label for="NoHPGuru">No HP Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["NoHPGuru"]; ?>" name="NoHPGuru" id="NoHPGuru" placeholder="Masukan No HP Guru">
                        </div>

                        <div class="mb-4">
                            <label for="NoWAGuru">No WA Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["NoWAGuru"]; ?>" name="NoWAGuru" id="NoWAGuru" placeholder="Masukan No WA Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDTelegramGuru">ID Telegram Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDTelegramGuru"]; ?>" name="IDTelegramGuru" id="IDTelegramGuru" placeholder="Masukan ID Telegram Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDLineGuru">ID Line Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDLineGuru"]; ?>" name="IDLineGuru" id="IDLineGuru" placeholder="Masukan ID Line Guru">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-4">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDFacebookGuru"]; ?>" name="IDFacebookGuru" id="IDFacebookGuru" placeholder="Masukan ID Facebook Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDInstagramGuru">ID Instagram Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDInstagramGuru"]; ?>" name="IDInstagramGuru" id="IDInstagramGuru" placeholder="Masukan ID Instagram Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDTwitterGuru">ID Twitter Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDTwitterGuru"]; ?>" name="IDTwitterGuru" id="IDTwitterGuru" placeholder="Masukan ID Twitter Guru">
                        </div>

                        <div class="mb-4">
                            <label for="IDYoutubeGuru">ID Youtube Guru</label>
                            <input type="text" class="form-control" value="<?php echo $dataDetailGuru["IDYoutubeGuru"]; ?>" name="IDYoutubeGuru" id="IDYoutubeGuru" placeholder="Masukan ID Youtube Guru">
                        </div>

                        <div class="mb-4">
                            <label for="EmailGuru">Email Guru</label>
                            <input type="email" class="form-control" value="<?php echo $dataDetailGuru["EmailGuru"]; ?>" name="EmailGuru" id="EmailGuru" placeholder="Masukan Email Guru">
                        </div>
