...
$detailMapel = ambil_data("SELECT * FROM tb_mata_pelajaran WHERE Kode_Mapel='$id'")[0];
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Mapel | Edit Data | <?php echo $detailMapel["Nama_Mapel"] ?></title>
...
<body>
    ...
    <main class="content">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center">Edit Data Mapel</h3>
                    <h4 class="text-center">"<?php echo $detailMapel["Nama_Mapel"] ?>"</h4>
                </div>
            </div>

            <form action="" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="Kode_MaPel" name="Kode_MaPel" value="<?php echo $detailMapel["Kode_MaPel"] ?>" >
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="<?php echo $detailMapel["Nama_Mapel"] ?>" class="form-control" name="Nama_Mapel" id="Nama_Mapel" placeholder="Masukan Nama Mapel">
                        </div>
                        <!-- End of Form -->

                        <!-- Form -->
                        <div class="mb-4">
                            <label for="Bidang_Mapel">Bidang Mapel</label>
                            <select class="form-select" id="Bidang_Mapel" name="Bidang_Mapel">
                                <?php if($detailMapel["Bidang_Mapel"] == "ipa") : ?>
                                <option>---Pilih---</option>
                                ...
                                <?php endif; ?>
                                <?php if($detailMapel["Bidang_Mapel"] == "ips") : ?>
                                <option>---Pilih---</option>
                                ...
                                <option value="agama">Agama</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Bidang_Mapel"] == "--Pilih--") : ?>
                                ...
                                <option value="agama">Agama</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Bidang_Mapel"] == "bahasa") : ?>
                                <option>---Pilih---</option>
                                <option value="ipa">IPA</option>
                                <option value="ips">IPS</option>
                                ...
                                <option value="agama">Agama</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Bidang_Mapel"] == "agama") : ?>
                                <option>---Pilih---</option>
                                <option value="ipa">IPA</option>
                                <option value="ips">IPS</option>
                                <option value="bahasa">Bahasa</option>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="Jenis_Mapel" name="Jenis_Mapel">
                                <?php if($detailMapel["Jenis_Mapel"] == "umum") : ?>
                                <option>---Pilih---</option>
                                <option value="umum" selected>Umum</option>
                                <option value="khusus">Khusus</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Jenis_Mapel"] == "khusus") : ?>
                                <option>---Pilih---</option>
                                <option value="umum">Umum</option>
                                <option value="khusus" selected>Khusus</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Jenis_Mapel"] == "--Pilih--") : ?>
                                <option selected>---Pilih---</option>
                                <option value="umum">Umum</option>
                                <option value="khusus">Khusus</option>
                                <?php endif; ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="Tipe_Mapel" name="Tipe_Mapel">
                                <?php if($detailMapel["Tipe_Mapel"] == "visual") : ?>
                                <option>---Pilih---</option>
                                <option value="visual" selected>Visual</option>
                                <option value="auditori">Auditori</option>
                                <option value="kinestetik">Kinestetik</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Tipe_Mapel"] == "auditori") : ?>
                                <option>---Pilih---</option>
                                <option value="visual">Visual</option>
                                <option value="auditori" selected>Auditori</option>
                                <option value="kinestetik">Kinestetik</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Tipe_Mapel"] == "--Pilih--") : ?>
                                <option selected>---Pilih---</option>
                                <option value="visual">Visual</option>
                                <option value="auditori">Auditori</option>
                                <option value="kinestetik">Kinestetik</option>
                                <?php endif; ?>
                                <?php if($detailMapel["Tipe_Mapel"] == "kinestetik") : ?>
                                <option>---Pilih---</option>
                                <option value="visual">Visual</option>
                                <option value="auditori">Auditori</option>
                                <option value="kinestetik" selected>Kinestetik</option>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="<?php echo $detailMapel["Jumlah_Pertemuan"] ?>" class="form-control" name="Jumlah_Pertemuan" id="Jumlah_Pertemuan" placeholder="Masukan Jumlah Pertemuan">
                        </div>
                        <!-- End of Form -->

                        <!-- Form -->
                        <div class="mb-4">
                            <label for="Durasi_Mapel">Durasi Mapel</label>
                            <input type="text" value="<?php echo $detailMapel["Durasi_Mapel"] ?>" class="form-control" name="Durasi_Mapel" id="Durasi_Mapel" placeholder="Masukan Durasi Mapel">
                        </div>
