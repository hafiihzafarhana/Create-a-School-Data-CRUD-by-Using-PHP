...
$detailJadwal = ambil_data("SELECT * FROM tb_jadwal_pelajaran WHERE IDJadwal='$id'")[0];
// print_r($detailJadwal);
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Jadwal | Edit Data | <?php echo $detailJadwal["IDJadwal"] ?></title>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class="text-center">"<?php echo $detailJadwal["IDJadwal"] ?>"</h4>
                </div>
            </div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        <!-- Form -->
                            ...
                            <input type="hidden" value="<?php echo $detailJadwal["IDJadwal"] ?>" class="form-control" name="IDJadwal" id="IDJadwal" placeholder="Masukan ID Jadwal">
                        <!-- End of Form -->

                        <!-- Form -->
                        <div class="mb-4">
                            <label for="No_Induk">Nama Murid</label>
                            <select class="form-select" id="No_Induk" name="No_Induk">
                                <?php 
                                    $sql = "SELECT No_Induk, Nama_Murid FROM tb_murid";
                                    $hasil = mysqli_query($conn,$sql);
                                    while ($data = mysqli_fetch_array($hasil)) :?>
                                    <?php 
                                        if($detailJadwal["No_Induk"] == $data["No_Induk"]){
                                            $select = "selected";
                                        }
                                        else{
                                            $select="";
                                    ...
                                    ?>
                                    <option <?php echo $select; ?> value="<?php echo $data['No_Induk'];?>"><?php echo $data['Nama_Murid']; ?> &nbsp;[<?php echo $data["No_Induk"] ?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <!-- End of Form -->
                        ...
                        <!-- Form -->
                        <div class="mb-4">
                            <label for="Kode_MaPel">Mapel</label>
                            <select class="form-select" id="Kode_MaPel" name="Kode_MaPel">
                                <?php 
                                    $sql_mapel = "SELECT Kode_MaPel, Nama_Mapel FROM tb_mata_pelajaran";
                                    $hasil_mapel = mysqli_query($conn,$sql_mapel);
                                    while ($data = mysqli_fetch_array($hasil_mapel)) :?>
                                    <?php 
                                        if($detailJadwal["Kode_MaPel"] == $data["Kode_MaPel"]){
                                            $select = "selected";
                                        }
                                        else{
                                            $select="";
                                    ...
                                    <option <?php echo $select; ?> value="<?php echo $data['Kode_MaPel'];?>"><?php echo $data['Nama_Mapel'];?>&nbsp;[<?php echo $data['Kode_MaPel'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="IDGuru" name="IDGuru">
                                <?php 
                                    $sql_guru = "SELECT IDGuru, NamaGuru FROM tb_guru";
                                    $hasil_guru = mysqli_query($conn,$sql_guru);
                                    while ($data = mysqli_fetch_array($hasil_guru)) :?>
                                    
                                    <?php 
                                        if($detailJadwal["IDGuru"] == $data["IDGuru"]){
                                            $select = "selected";
                                        }
                                        else{
                                            $select="";
                                    ...
                                    <option <?php echo $select; ?> value="<?php echo $data['IDGuru'];?>"><?php echo $data['NamaGuru'];?>&nbsp;[<?php echo $data['IDGuru'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="IDRuang" name="IDRuang">
                                <?php 
                                    $sql_ruang = "SELECT IDRuang, Nama_Ruang FROM tb_ruang_kelas";
                                    $hasil_ruang = mysqli_query($conn,$sql_ruang);
                                    while ($data = mysqli_fetch_array($hasil_ruang)) :?>
                                    
                                    <?php 
                                        if($detailJadwal["IDRuang"] == $data["IDRuang"]){
                                            $select = "selected";
                                        }
                                        else{
                                            $select="";
                                    ...
                                    <option <?php echo $select; ?> value="<?php echo $data['IDRuang'];?>"><?php echo $data['Nama_Ruang'];?>&nbsp;[<?php echo $data['IDRuang'];?>]</option>
                                <?php endwhile; ?>
                            </select>
                        </div>

                        <button type="submit" class="btn btn-success text-white" name="tambah" id="tambah">Update Data</button>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" value="<?php echo $detailJadwal["SesiJadwal"] ?>" type="text" placeholder="Masukan Sesi Jadwal" name="SesiJadwal" id="SesiJadwal">
                        </div>

                        <div class="mb-4">
                            <label for="Waktu_Mulai">Waktu Mulai</label>
                            <input class="form-control" value="<?php echo $detailJadwal["Waktu_Mulai"] ?>" type="time" placeholder="Masukan Waktu Mulai" name="Waktu_Mulai" id="Waktu_Mulai">
                        </div>
