...
if (isset($_POST['tambah'])) {
    if (tambah_data_kelas($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'tambah_data_kelas.php';
        </script>
        ";
    }
}
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Dashboard Kelas | Tambah Data</title>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="row mb-4">
                    <div class="col-lg-4 col-sm-4">
                        <!-- Form -->
                        <div class="mb-4">
                            <label for="IDRuang">ID Kelas</label>
                            <input type="text" class="form-control" name="IDRuang" id="IDRuang" placeholder="Masukan ID Kelas">
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="Nama_Ruang" id="Nama_Ruang" placeholder="Masukan Nama kelas">
                        </div>
                        <!-- End of Form -->
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="Keterangan_Ruang" placeholder="Masukan Keterangan Untuk Ruangan" id="Keterangan_Ruang" cols="30" rows="5"></textarea>
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="Kelengkapan_Alat" placeholder="Masukan Kelengkapan Untuk Ruangan" id="Kelengkapan_Alat" cols="30" rows="5"></textarea>
                        </div>
                        <!-- End of Form -->
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="date" name="Renovasi_Terakhir" id="Renovasi_Terakhir">
                        </div>
                    </div>
                </div>
            </form>
