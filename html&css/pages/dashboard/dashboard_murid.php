...
$result = ambil_data("Select * FROM tb_murid");
...
<body>
  ...
  <main class="content">
    ...
    <div class="py-4">
        <a href="./tambah_data_murid.php" class="btn btn-success text-white">
                        ...
                        <table class="table table-centered table-nowrap mb-0 rounded">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="edit_data_murid.php?id=<?php echo $data["No_Induk"]?>" class="btn btn-warning badge">Edit</a>
                                    <a href="detail_data_murid.php?id=<?php echo $data["No_Induk"]?>" class="btn btn-info badge">Detail</a>
                                    <a href="hapus_data_murid.php?id=<?php echo $data['No_Induk']?>" class="btn btn-danger badge">Hapus</a>
                                  </td>
                                </tr>
                                <!-- End of Item -->
                                <?php $i++ ?>
